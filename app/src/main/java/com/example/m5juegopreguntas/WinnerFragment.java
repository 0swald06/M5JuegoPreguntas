...
import com.example.m5juegopreguntas.databinding.FragmentWinnerBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding.denuevo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.winnerFragment, QuestionFragment.newInstance("Hola","Hola"));
